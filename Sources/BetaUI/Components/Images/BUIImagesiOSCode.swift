//
//  BUIImagesiOSCode.swift
//  BUIImages
//
//  Created by Szabolcs Toth on 2022. 01. 18..
...
public class BUIImagesiOSCode : NSObject {
    ...
    @objc dynamic public class func drawBUIUserProfileImage(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 26, height: 26), resizing: ResizingBehavior = .aspectFit) {
        ...
        BUIImagesiOSCode.kMainColor3.setFill()
        ovalPath.fill()
    ...
    @objc dynamic public class func drawBUILogoImage(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 26, height: 26), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// image
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 3, y: 5, width: 20, height: 16), cornerRadius: 2)
        BUIImagesiOSCode.kMainColor3.setFill()
        rectanglePath.fill()
        BUIImagesiOSCode.kMainColor1.setStroke()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 23, y: 16))
        bezierPath.addLine(to: CGPoint(x: 18, y: 10))
        bezierPath.addLine(to: CGPoint(x: 12, y: 18))
        bezierPath.addLine(to: CGPoint(x: 7, y: 14))
        bezierPath.addLine(to: CGPoint(x: 3, y: 17))
        bezierPath.addLine(to: CGPoint(x: 3, y: 19))
        bezierPath.addCurve(to: CGPoint(x: 5, y: 21), controlPoint1: CGPoint(x: 3, y: 20.1), controlPoint2: CGPoint(x: 3.9, y: 21))
        bezierPath.addLine(to: CGPoint(x: 21, y: 21))
        bezierPath.addCurve(to: CGPoint(x: 23, y: 19), controlPoint1: CGPoint(x: 22.1, y: 21), controlPoint2: CGPoint(x: 23, y: 20.1))
        bezierPath.addLine(to: CGPoint(x: 23, y: 16))
        bezierPath.close()
        ...
        bezier2Path.move(to: CGPoint(x: 8, y: 10))
        bezier2Path.addCurve(to: CGPoint(x: 9, y: 9), controlPoint1: CGPoint(x: 8.55, y: 10), controlPoint2: CGPoint(x: 9, y: 9.55))
        bezier2Path.addCurve(to: CGPoint(x: 8, y: 8), controlPoint1: CGPoint(x: 9, y: 8.45), controlPoint2: CGPoint(x: 8.55, y: 8))
        bezier2Path.addCurve(to: CGPoint(x: 7, y: 9), controlPoint1: CGPoint(x: 7.45, y: 8), controlPoint2: CGPoint(x: 7, y: 8.45))
        bezier2Path.addCurve(to: CGPoint(x: 8, y: 10), controlPoint1: CGPoint(x: 7, y: 9.55), controlPoint2: CGPoint(x: 7.45, y: 10))
        bezier2Path.close()
        BUIImagesiOSCode.kMainColor1.setFill()
        bezier2Path.fill()
        BUIImagesiOSCode.kMainColor1.setStroke()
